...
namespace AI.SmartStandards.KnowledgeAccess {
  ...
  internal static class KnowledgeRepositoryHttpRouteNames {
    ...
    internal const string _RawRoot =
      "KnowledgeRepository.Raw.Root";

    internal const string _RawArea =
      "KnowledgeRepository.Raw.Area";

    internal const string _RawResource =
      "KnowledgeRepository.Raw.Resource";

    internal const string _HtmlRoot =
      "KnowledgeRepository.Html.Root";

    internal const string _HtmlArea =
      "KnowledgeRepository.Html.Area";
  }
}
